# PostgreSQL 날짜별 데이터 테이블 마이그레이션 도구

PostgreSQL 9.3의 날짜별 데이터 테이블을 효율적으로 마이그레이션하는 GUI 도구입니다.

## 주요 기능

- 📊 **테이블 자동 탐색**: 날짜 범위로 데이터 테이블 자동 검색
...
- **전체 진행률**: 완료된 테이블 수 / 전체 테이블 수
- **현재 테이블**: 처리 중인 테이블과 행 수
...
**참고**: 이 도구는 PostgreSQL 9.3의 트리거 기반 날짜별 데이터 테이블을 위해 특별히 설계되었습니다.
다른 테이블 구조의 경우 수정이 필요할 수 있습니다.
