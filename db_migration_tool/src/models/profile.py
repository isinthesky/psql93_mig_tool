...
from src.database.local_db import get_db, Profile
...
class ConnectionProfile:
    ...
    def from_db_model(cls, db_profile: Profile, cipher_suite: Fernet) -> 'ConnectionProfile':
        ...
        source_config = json.loads(
            cipher_suite.decrypt(db_profile.source_config.encode()).decode()
        )
        target_config = json.loads(
            cipher_suite.decrypt(db_profile.target_config.encode()).decode()
        )
