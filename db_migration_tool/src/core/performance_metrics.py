...
class PerformanceMetrics:
    ...
    def get_stats(self) -> dict[str, any]:
        ...
        avg_mb_per_sec = (
            (self.total_bytes / (1024 * 1024)) / elapsed_seconds if elapsed_seconds > 0 else 0
        )
    ...
    def _calculate_eta(self, current_rate: float) -> float:
        ...
        estimated_remaining_rows = remaining_in_current + (
            remaining_partitions * self.current_partition_total_rows
        )
