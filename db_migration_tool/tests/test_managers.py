...
class TestProfileManager:
    ...
    def test_create_profile_rollback_on_error(
...
class TestHistoryManager:
    ...
    def test_create_history(self, history_manager):
        ...
        history = history_manager.create_history(
            profile_id=1, start_date="2024-01-01", end_date="2024-01-31"
        )
...
class TestCheckpointManager:
    ...
    def test_create_checkpoint(self, checkpoint_manager, history_id):
        ...
        checkpoint = checkpoint_manager.create_checkpoint(
            history_id=history_id, partition_name="test_partition_240101"
        )
