...
from src.database.repository import BaseRepository, HistoryRepository, CheckpointRepository
from src.database.local_db import MigrationHistory, Checkpoint
...
class TestCheckpointRepository:
    ...
    def test_create_checkpoint(self, checkpoint_repo, sample_history_id):
        ...
        checkpoint = checkpoint_repo.create(
            ...
            partition_name='partition_240101',
            status='pending'
        )
    ...
    def test_get_pending_by_history(self, checkpoint_repo, sample_history_id):
        ...
        completed_cp = checkpoint_repo.create(
            history_id=sample_history_id,
            partition_name='completed_partition',
            status='completed'
        )
        pending_cp = checkpoint_repo.create(
            history_id=sample_history_id,
            partition_name='pending_partition',
            status='pending'
        )
